"""Q1 OFFLINE runner — runs the mocked test matrix (no connection). Exit 0 iff all pass."""
...
def main():
    print("=== Q1 XAUUSD QUOTE CAPTURE — OFFLINE ===")
    ...
    print(f"\n=== Q1 OFFLINE SUMMARY ===  passed={passed} failed={failed}")
